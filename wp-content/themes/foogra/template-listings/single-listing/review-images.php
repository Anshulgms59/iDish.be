	...
	foreach ($attachments as $attachmentId) {
		...
		if ( isset($img[0]) && $img[0] ) {
			...
			<div class="col-sm-3 col-3 attachment <?php echo esc_attr($count > 4 ? 'd-none' : ''); ?>">
				<a class="popup-image-gallery" href="<?php echo esc_url($attachmentLink); ?>" data-elementor-lightbox-slideshow="foogra-comment-gallery-<?php echo esc_attr(get_comment_ID()); ?>">

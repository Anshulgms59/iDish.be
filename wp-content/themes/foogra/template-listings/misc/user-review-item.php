			...
			<div class="clearfix">
				...
				<div class="d-flex align-items-center">
					<?php if ( $comment->comment_approved == '0' ) : ?>
						<span class="date"><em><?php esc_html_e( 'Your comment is awaiting approval', 'foogra' ); ?></em></span>
					<?php else : ?>
						<span class="date">
					...
					<div class="star-rating ms-auto" title="<?php echo sprintf( esc_attr__( 'Rated %d out of 5', 'foogra' ), $rating ) ?>">

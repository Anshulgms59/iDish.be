...
class Foogra_Elementor_Submit_Btn extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header Submit Button', 'foogra' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'hover_animation',
            [
                'label' => esc_html__( 'Hover Animation', 'foogra' ),
...
Elementor\Plugin::instance()->widgets_manager->register( new Foogra_Elementor_Submit_Btn );
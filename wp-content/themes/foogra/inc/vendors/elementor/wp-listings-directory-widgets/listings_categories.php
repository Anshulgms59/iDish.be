...
class Foogra_Elementor_Listings_Directory_Listing_Categories extends Elementor\Widget_Base {

	public function get_name() {
        return 'apus_element_listing_categories';
    }

	public function get_title() {
        return esc_html__( 'Apus Listing Categories', 'foogra' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Categories Banner', 'foogra' ),
        ...
        $this->add_control(
            'categories',
            [
                'label' => esc_html__( 'Categories Box', 'foogra' ),
	...
	protected function render() {
        ...
        ?>
            <div class="widget-listing-categories <?php echo esc_attr($el_class); ?>">
                ...
                ?>
                    <div class="slick-carousel gap-20 <?php echo ( ( $columns >= count($categories))?'hidden-dots':'' ); ?>"
                        ...
                        <?php foreach ($categories as $item) {
                            $term = get_term_by( 'slug', $item['slug'], 'listing_category' );
                            ...
                            $addclass = "";
                            if($item['image_icon'] == 'image' && !empty($item['img_bg_src']['id']) ){
                                $addclass = "has-image";
                            }

                            ?>
                            <div class="item">
                                <a class="category-banner-inner <?php echo esc_attr($style.' '.$addclass); ?>" href="<?php echo esc_url($link); ?>">
                                    ...
                                    ?>
                                    <div class="number"><?php echo sprintf("%02d", $number_listings); ?></div>
                                    <?php } ?>
                                    ...
                                    <?php } else {
                                        ...
                                        ?>
                                            <div class="banner-icon"><i class="<?php echo esc_attr($item['category_icon']); ?>"></i></div>
                                        <?php }
                                    } ?>
                                    ...
                                    <div class="inner">
                                        ...
                                        <?php if ( !empty($term->description) ) { ?>
                                            <small>
                                                <?php echo trim($term->description); ?>
                                            </small>
                                        <?php }  ?>
...
Elementor\Plugin::instance()->widgets_manager->register( new Foogra_Elementor_Listings_Directory_Listing_Categories );
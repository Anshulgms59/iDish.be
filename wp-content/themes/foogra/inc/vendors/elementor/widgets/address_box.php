...
class Foogra_Elementor_Address_Box extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Address Box', 'foogra' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Address Box', 'foogra' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .address-box-image ' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .address-box-image',
            ]
        );
	...
	protected function render() {
        ...
        if ( !empty($features) ) {
            ?>
            <div class="widget-address-box <?php echo esc_attr($el_class); ?>">
                <div class="row">
                    <?php foreach ($features as $item): ?>
                        <div class="item col-12 col-sm-<?php echo esc_attr(12/$columns);?>">
                            <div class="item-address <?php echo trim($style); ?>">
                                 <div class="top-inner">
                                    <?php
                                    ...
                                    if ( $item['image_icon'] == 'image' ) {
                                        if ( ! empty( $item['image']['url'] ) ) {
                                            ...
                                            $html .= '<div class="address-box-image img">' . $image_html . '</div>';
                                        }
                                    } elseif ( $item['image_icon'] == 'icon' && !empty($item['icon'])) {
                                        $html .= '<div class="address-box-image icon"><i class="'.$item['icon'].'"></i></div>';
                                    }
                                $html .= '</div>';
                                if ( $has_content ) {
...
Plugin::instance()->widgets_manager->register( new Foogra_Elementor_Address_Box );
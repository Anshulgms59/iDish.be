...
class Foogra_Elementor_Social_Links extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Social Links', 'foogra' );
    }
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            'title', [
                'label' => esc_html__( 'Social Title', 'foogra' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Social Title' , 'foogra' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'social_icon_list',
            [
                'label' => esc_html__( 'Social Icons', 'foogra' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    '' => esc_html__('Circle', 'foogra'),
                    'st_normal' => esc_html__('Normal', 'foogra'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->start_controls_section(
            'section_title_style',
            [
                'label' => esc_html__( 'Social', 'foogra' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
...
Plugin::instance()->widgets_manager->register( new Foogra_Elementor_Social_Links );
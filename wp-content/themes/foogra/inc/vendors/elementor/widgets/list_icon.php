...
class Foogra_Elementor_List_Icon extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus List Icon', 'foogra' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'List Icon', 'foogra' ),
        ...
        $this->add_responsive_control(
                'margin-title',
                [
                    'label' => esc_html__( 'Margin Title', 'foogra' ),
...
Plugin::instance()->widgets_manager->register( new Foogra_Elementor_List_Icon );
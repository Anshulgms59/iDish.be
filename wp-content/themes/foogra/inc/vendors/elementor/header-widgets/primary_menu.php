...
class Foogra_Elementor_Primary_Menu extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header Primary Menu', 'foogra' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'effect',
            [
                'label' => esc_html__( 'Effect Dropdown Menu', 'foogra' ),
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => array(
                    'effect1' => esc_html__('Effect 1', 'foogra'),
                    'effect2' => esc_html__('Effect 2', 'foogra'),
                    'effect3' => esc_html__('Effect 3', 'foogra'),
                ),
                'default' => 'effect1'
            ]
        );
        ...
        $this->add_responsive_control(
            'content_padding',
            [
                'label' => esc_html__( 'Padding Menu', 'foogra' ),
        ...
        $this->add_control(
            'menu_color',
            [
                'label' => esc_html__( 'Color Menu', 'foogra' ),
        ...
        $this->add_control(
            'menu_hover_color',
            [
                'label' => esc_html__( 'Color Hover Menu', 'foogra' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_control(
            'dp_color',
            [
                'label' => esc_html__( 'Color Dropdown Menu', 'foogra' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_control(
            'dp_hover_color',
            [
                'label' => esc_html__( 'Color Hover Dropdown Menu', 'foogra' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_control(
            'bg_dp_color',
            [
                'label' => esc_html__( 'Background Color Dropdown Menu', 'foogra' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
...
Elementor\Plugin::instance()->widgets_manager->register( new Foogra_Elementor_Primary_Menu );
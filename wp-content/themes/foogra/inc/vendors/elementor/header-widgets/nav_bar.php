...
class Foogra_Elementor_Nav_Bar extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header NavBar', 'foogra' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'st_right' => esc_html__( 'Right', 'foogra' ),
                    'st_left' => esc_html__( 'Left', 'foogra' ),
                ],
                'default' => 'st_right'
            ]
        );
        ...
        $this->add_control(
            'icon_color',
            [
                'label' => esc_html__( 'Color Icon', 'foogra' ),
	...
	protected function render() {
        ...
        <div class="navbar-wrapper <?php echo esc_attr($el_class.' '.$style); ?>">
            ...
            <div class="navbar-sidebar-wrapper">
                <a href="javascript:void(0);" class="close-navbar-sidebar"><i class="icon_close"></i></a>
                <?php
                $ele_obj = \Elementor\Plugin::$instance;
                $content_html = '';
                ...
                if ( '0' !== $item_template_id ) {
                    ...
                    if ( ! empty( $template_content ) ) {
                        ...
                        if ( Plugin::$instance->editor->is_edit_mode() ) {
                            ...
                            $content_html .= sprintf( '<div class="uomo__edit-cover" data-template-edit-link="%s"><i class="fa fa-pencil"></i><span>%s</span></div>', $link, esc_html__( 'Edit Template', 'foogra' ) );
                        }
                    } else {
...
Plugin::instance()->widgets_manager->register( new Foogra_Elementor_Nav_Bar );
...
class Foogra_Widget_Search extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'foogra'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'foogra' ), )
        );
...
call_user_func( implode('_', array('register', 'widget') ), 'Foogra_Widget_Search' );

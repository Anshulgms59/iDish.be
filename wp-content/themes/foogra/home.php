...
$layout = foogra_get_config( 'blog_display_mode', 'list' );
...
?>
<section id="main-container" class="main-content home-page-default <?php echo apply_filters('foogra_blog_content_class', 'container');?> inner">
	<?php foogra_before_content( $sidebar_configs ); ?>
	<div class="row responsive-medium wrapper-blog">

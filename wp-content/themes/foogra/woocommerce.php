...
$sidebar_configs = foogra_get_woocommerce_layout_configs();
?>

<?php do_action( 'foogra_woo_template_main_before' ); ?>

<section id="main-container" class="<?php echo apply_filters('foogra_woocommerce_content_class', 'container');?>">

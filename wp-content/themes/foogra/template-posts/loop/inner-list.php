        ...
        <?php if (get_the_title()) { ?>
            <h4 class="entry-title">
                <?php if ( is_sticky() && is_home() && ! is_paged() ) : ?>
                    <div class="stick-icon text-theme"><i class="icon_pushpin_alt"></i></div>
                <?php endif; ?>
                <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
            </h4>
        <?php } ?>
        <div class="description d-md-none"><?php echo foogra_substring( get_the_excerpt(),20, '...' ); ?></div>
        <div class="description d-none d-md-block"><?php echo foogra_substring( get_the_excerpt(),35, '...' ); ?></div>

...
<div class="reply-message-form-wrapper">
	<form id="reply-message-form" class="reply-message-form" action="?" method="post">
        ...
        <div class="wrapper-form">
            <textarea class="form-control" name="message" placeholder="<?php esc_attr_e( 'Write your message...', 'foogra' ); ?>" required="required"></textarea>
            <button class="button btn btn-theme reply-message-btn"><?php echo esc_html__('Send Message','foogra') ?></button>
        </div><!-- /.form-group -->

<?php
    $relate_count = foogra_get_config('number_blog_related', 2);
    $relate_columns = foogra_get_config('related_blog_columns', 2);
...
<div class="wrapper-posts-related">
    <div class="<?php echo apply_filters( 'foogra_blog_content_class', 'container' ); ?>">
        <div class="related-posts">
            <h4 class="title">
                <?php esc_html_e( 'Related Posts', 'foogra' ); ?>
            </h4>

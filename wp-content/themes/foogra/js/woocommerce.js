    ...
    $.extend($.apusThemeCore, {
        ...
        productDetail: function(){
            ...
            $('body').on('click', '.view-more-desc', function() {
                ...
                if ( $this.hasClass('view-more') ) {
                    var linkText = foogra_woo_options.view_less_text;
                    $content.removeClass("hideContent").addClass("showContent");
                    $this.removeClass("view-more").addClass("view-less");
                } else {
                    var linkText = foogra_woo_options.view_more_text;
        ...
        initQuickview: function(){
            ...
            $('body').on('click', 'a.quickview', function (e) {
                ...
                var url = foogra_woo_options.ajaxurl + '?action=foogra_quickview_product&product_id=' + product_id;
        ...
        initSidebar: function() {
            ...
            $('.widget_product_categories ul.product-categories').each(function(e){
                ...
                if ( height > 260 ) {
                    var view_more = '<a href="javascript:void(0);" class="view-more-list-cat view-more"><span>'+foogra_woo_options.view_more_text+'</span> <i class="fa fa-angle-double-right"></i></a>';
            ...
            $('.woocommerce-widget-layered-nav-list').each(function(e){
                var height = $(this).outerHeight();
                if ( height > 260 ) {
                    var view_more = '<a href="javascript:void(0);" class="view-more-list view-more"><span>'+foogra_woo_options.view_more_text+'</span> <i class="fa fa-angle-double-right"></i></a>';
                    $(this).parent().append(view_more);
                    $(this).addClass('hideContent');
                }
            });

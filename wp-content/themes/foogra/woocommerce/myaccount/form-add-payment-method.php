	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-group">
				...
				<button type="submit" class="button alt" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'foogra' ); ?>"><?php esc_html_e( 'Add payment method', 'foogra' ); ?></button>
				<input type="hidden" name="woocommerce_add_payment_method" id="woocommerce_add_payment_method" value="1" />
			</div>
		</div>
	</form>
<?php else : ?>
	<p class="woocommerce-notice woocommerce-notice--info woocommerce-info"><?php esc_html_e( 'New payment methods can only be added during checkout. Please contact us if you require assistance.', 'foogra' ); ?></p>
<?php endif; ?>
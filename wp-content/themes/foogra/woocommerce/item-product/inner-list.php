	...
	<div class="row flex-middle-sm">
		<div class="col-xs-5 col-sm-3 col-lg-3">	
			<div class="wrapper-image">
			    ...
			    <figure class="image">
			        ...
			        <?php do_action('foogra_woocommerce_before_shop_loop_item'); ?>
			    </figure>
			</div> 
		</div>
		<div class="col-xs-7 col-sm-5 col-lg-6">
		    <div class="wrapper-info">
	            ...
	            <div class="product-excerpt">
		           <?php echo foogra_substring( get_the_excerpt(), 50, '...' ); ?>
		        </div>
			</div>
		</div> 
		<div class="col-12 col-sm-4 col-lg-3">
			<div class="left-infor">
				<?php 
					do_action('foogra_list_shipping_info');
					add_action( 'foogra_list_price', 'woocommerce_template_loop_price', 10 );
					do_action('foogra_list_price');
				?>

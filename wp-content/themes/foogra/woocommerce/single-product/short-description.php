...
$layout = foogra_get_config('product_single_version', 'v1');
?>
<div class="woocommerce-product-details__short-description-wrapper <?php echo esc_attr($layout == 'v2' ? 'v2' : ''); ?>">
	...
	<?php if ( $layout == 'v2' ) { ?>
		<a href="javascript:void(0);" class="view-more-desc view-more"><span><?php esc_html_e('View More', 'foogra'); ?></span> <i class="fa fa-angle-double-right"></i></a>
	<?php } ?>
</div>
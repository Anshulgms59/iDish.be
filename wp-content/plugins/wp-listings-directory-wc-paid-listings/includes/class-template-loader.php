...
class WP_Listings_Directory_Wc_Paid_Listings_Template_Loader {
	 ...
	 * @throws Exception
	 */
	public static function locate( $name, $plugin_dir = WP_LISTINGS_DIRECTORY_WC_PAID_LISTINGS_PLUGIN_DIR ) {
		$template = '';
		...
		$theme_folder_name = apply_filters( 'wp-listings-directory-wc-paid-listings-theme-folder-name', 'wp-listings-directory-wc-paid-listings' );
		// Child theme
	 ...
	 * @throws Exception
	 */
	public static function get_template_part( $name, $args = array(), $plugin_dir = WP_LISTINGS_DIRECTORY_WC_PAID_LISTINGS_PLUGIN_DIR ) {
